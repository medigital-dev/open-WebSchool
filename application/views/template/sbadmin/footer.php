...
<footer class="sticky-footer bg-white">
    <div class="container-fluid my-auto">
        <div class="copyright text-center my-auto">
            <span><a href="https://me-digital.net"><img src="<?= base_url(); ?>assets/global/images/me-digital.png" alt="Logo me-Digital.net" class="img-thumbnail align-middle" style="height: 30px;"></a> | meSchool_v1.0</span>
            <!-- <span>&copy; <?= date('Y', time()); ?> | <a href="https://www.smp2wonosari.sch.id" class="text-decoration-none" target="_blank"><?= base_url(); ?></a></span> -->
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<script src="<?= base_url('assets/summernote/plugin/'); ?>summernote-files.js"></script>
