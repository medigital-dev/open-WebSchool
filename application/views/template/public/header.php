        ...
        <div class="container px-4">
            ...
            <div class="collapse navbar-collapse" id="menuUtama">
                ...
                <ul class="navbar-nav navbar-nav-scroll ms-auto">
                    ...
                    <form method="POST" autocomplete="off" action="<?= base_url(); ?>blogs" class="d-flex me-2">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-outline-light" type="submit"><i class="fas fa-search fa-fw"></i></button>
                        </div>
                    </form>


                    <!-- <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" title="Menu">
                            ...
                            <form method="POST" autocomplete="off" action="<?= base_url(); ?>cari">
                                ...
                                <li>
                                    <div class="dropdown-item">
                                        <input class="form-control" type="search" id="keyword" name="keyword" placeholder="Cari informasi" aria-label="Search">
                                    </div>
                                </li>
                                </div>
                            </form>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg-end" aria-labelledby="navbarDropdown">
                            <li>
                                <a href="<?= base_url(); ?>admin" class="dropdown-item text-center" title="Admin Page">
                                    <i class="fas fa-user-cog fa-fw text-success"></i>
                                    Admin Page
                                </a>
                            </li>
                            <!-- <li>
                                <a href="<?= base_url(); ?>admin/pesan" class="dropdown-item">
                                    ...
                                    <span class="position-absolut top-0 start-100 translate-middle badge rounded-pill bg-danger"><?= count($pesanBaru); ?></span>
                                    Pesan
                                </a>
                            </li> -->
                            <?php if (isset($_SESSION['user'])) : ?>
                                ...
                                <div class="d-flex justify-content-around pt-2" style="min-width: 100px;">
